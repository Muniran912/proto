<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="proto.index" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderTitle" runat="server"> My new webpage
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderH1" runat="server">Heading 1
</asp:Content>

<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolderH2" runat="server"> My Page Content
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolderBodyContent" runat="server"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus ante quam, consectetur id congue sed, dictum non risus. Ut luctus porttitor magna, eu consequat ipsum venenatis dictum. Morbi scelerisque pellentesque augue, eget cursus orci hendrerit at. Nunc vehicula nisi in enim sagittis faucibus. Praesent gravida pulvinar risus ac auctor. Aliquam vitae tristique sapien. Pellentesque sed odio et tellus ullamcorper vestibulum ac hendrerit nibh.
</p><p>
